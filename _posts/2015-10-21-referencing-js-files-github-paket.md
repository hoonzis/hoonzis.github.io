Paket is a dependency manager for .NET projects, besides referencing NuGet packages, one can reference as well any file from GitHub. One can reference any file from GitHub just by adding single line to **paket.dependencies** files.
